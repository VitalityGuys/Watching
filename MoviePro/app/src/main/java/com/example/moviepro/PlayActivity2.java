        ...
        HttpUtil.get(videoDetailUrl, new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(PlayActivity2.this,"加载视频失败，请刷新重试",Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    //提示信息
                    Toast.makeText(PlayActivity2.this,"正在加载，请稍后",Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
        ...
        mVideoView.setOnPreparedListener(new IMediaPlayer.OnPreparedListener() {
            ...
            public void onPrepared(IMediaPlayer mp) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(PlayActivity2.this,"加载完成",Toast.LENGTH_SHORT).show();
                    }
                });
                //加载成功，进度条不可见
...
//      final ArrayList<PlayLink> tmp=videoDetail.getPlaylists_mp4();
        ...
        for(i=0;i<length/4+1;i++){
            for(j=0;j<4;j++){
                ...
                final Button button=new Button(PlayActivity2.this);
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(PlayActivity2.this,"正在加载"+tmp.get(index).getVideonum(),Toast.LENGTH_SHORT).show();
    ...
    private void setDetailInfo(VideoDetail videoDetail){
        Glide.with(PlayActivity2.this).load(videoDetail.getCoverimage()).into(coverimg);
